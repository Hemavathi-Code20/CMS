...
const MaintenanceForm = ({ onAddSuccess, editData }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEditMode) {
        await axios.put(
          `https://clinic-management-lrw8.onrender.com/api/admin/maintenance/${editData._id}`,
          {
            assetName,
        ...
        await axios.post("https://clinic-management-lrw8.onrender.com/api/admin/maintenance", {
          assetName,
          scheduledDate: new Date(scheduledDate),
          technician,
          maintenanceType,
